...
constexpr auto GRID_WIDTH = 16; // 格子宽度
constexpr auto GRID_HEIGHT = 16; // 格子高度
constexpr auto GRID_ROW = (HEIGHT / GRID_HEIGHT); // 格子行数
constexpr auto GRID_COL = (WIDTH / GRID_WIDTH); // 格子列数
constexpr auto SNAKE_SIZE = (GRID_ROW * GRID_COL); // 蛇最大节数
